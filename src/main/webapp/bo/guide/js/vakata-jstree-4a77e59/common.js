...
/* =====================================
* search-control 스타일을 위한 퍼블리시
* =====================================
*/
$(function() {
	if( $('.search-control .form-set').length == 1 ) {
		$('.form-set').css({'postion': 'relative', 'width': 'auto', 'min-width': 'unset'});
		console.log('갯수', $('.search-control .form-set').length);
	}
})
