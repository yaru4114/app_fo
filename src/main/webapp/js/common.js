...
$(document).off('click', '.web-sidebar .has-submenu > .sidebar-1depth').on('click', '.web-sidebar .has-submenu > .sidebar-1depth', function () {
...
$(document).off('click', '.web-sidebar .sidebar-2depth.has-submenu > a').on('click', '.web-sidebar .sidebar-2depth.has-submenu > a', function () {
...
$(function() {
	...
	$('body').off('focus', '.form-month').on('focus', '.form-month', function() { // Id's Containing "datepickerfrom" string, bind the datetimepicker
        $(this).datepicker({
            format: "yyyy-mm",
			startView: 1,
			minViewMode: 1,
...
$(function() {
	...
	$('body').off('focus', '.form-date').on('focus', '.form-date', function() { // Id's Containing "datepickerfrom" string, bind the datetimepicker
        $(this).datepicker({
            format: "yyyy-mm-dd",
			keyboardNavigation: false,
			forceParse: false,
...
$(function() {
	...
	$('body').off('focus', '.form-time .input').on('focus', '.form-time .input', function() { //
		$(this).timepicker({
			minuteStep: 1,
			defaultTime: '',
			showSeconds: false,
...
$(function () {
	$(".btn-file").click(function () {
		$(this).find('[type=file]').not('.is-evented').off('change').on('change', function () {
			var value = $(this).val();
...
$(function () {
	$('.table-del').off('click').on('click', function () {
