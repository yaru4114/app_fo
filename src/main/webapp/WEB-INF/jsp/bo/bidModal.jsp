                                ...
                                <div class="table table-view">
                                    <table>
                                                ...
                                                <div class="table table-inner">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-set">
                                                                    <input type="text" class="input" value="200"
                                                                           readonly="readonly">
                                                                    <select class="form-select select-sm">
                                                                        <option value="선택">선택</option>
                                                                        <option value="선택">선택</option>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <ul class="color-red">
                                                    <li>기타) 부산/인천 보세창고 상차도 조건일 경우 인천지역(+USD8/MT),부산지역(+USD10/MT)을 조정하여
                                                        <u>환산 프리미엄으로 입찰 가격 적용</u></li>
                                                    <li>기타) 부산/인천 보세창고 낙찰될 경우 해당 운송에 대해서는 서린상사 지정 운송업체를 통해 운송시 서린상사가 해당
